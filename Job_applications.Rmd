...
As we can see above, our KNN model, with k = 3, was able to predict whether someone is employed (`hired` or `not_hired`) with an accuracy of 72%.
...
# Make predictions. This SVM model consumes more than 4+ GB of RAM during runtime. We need to scale down the data we're passing to it.
