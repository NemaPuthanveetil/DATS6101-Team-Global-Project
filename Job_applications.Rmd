...
plot(roc_lr, print.auc = T, main = "ROC Curve for SVM Model", col = "#514BA2", lwd = 2)


```
We obtain an Area under the curve as `r auc(lr_model)` which is an amazing value, so the Logistic regression model works well.
